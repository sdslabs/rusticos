...
pub unsafe fn init_syscalls() {
    let handle_addr = handle_syscall as *const () as u64;
    ...
    mov rdx, rax
    shr rdx, 32
    wrmsr", in("rax") handle_addr, in("rcx") MSR_LSTAR, out("rdx") _);
...
fn handle_syscall() {
    ...
    let (syscall, arg0, arg1, arg2, arg3): (u64, u64, u64, u64, u64);
    unsafe {
    ...
    let retval: i64 = match syscall {
        0x595ca11a => dummy_syscall_0(arg0, arg1, arg2, arg3),
        0x595ca11b => dummy_syscall_1(arg0, arg1, arg2, arg3),
        _ => -1,
    };
    unsafe {
        asm!("\
